...
function calcularPremio() {
  ...
  else if (tipus === "falta" && numero === "falta" && win_number >= 0 && win_number <= 18 || tipus === "pasa" && numero === "pasa" && win_number >= 19 && win_number <= 36) {
      prize = quantitat;
    } // PARELL/SENAR
    else if (tipus === "par" && numero === "par" && win_number % 2 == 0 || tipus === "impar" && numero === "impar" && win_number % 2 != 0) {
        prize = quantitat;
      } // VERMELL/NEGRE
      else if (tipus === "color" && numero === "rojo" && numerosrojos.includes(win_number) || tipus === "color" && numero === "negro" && win_number !== 0 && !numerosrojos.includes(win_number)) {
          prize = quantitat;
        } // DOTZENA
  ...
  if (prize > 0) {
    mensaje = "Cantidad apostada: " + quantitat + "€. " + "Número ganador: " + win_number + ". " + "¡Has ganado " + prize + "€! ";
  } else {
    prize = -quantitat / 2;
    mensaje = "Cantidad apostada: " + quantitat + "€. " + "Número ganador: " + win_number + ". " + "Has perdido, tienes " + prize + "€. ";
  }
